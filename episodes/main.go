...
func announce(ctx context.Context, service *youtube.Service, episode Episode) error {
	return nil
}
...
func main() {
	...
	var action func(context.Context, *youtube.Service, Episode) error
	switch os.Args[1] {
	case "announce":
		action = announce
	default:
	...
	err = action(ctx, service, episode)
	if err != nil {
